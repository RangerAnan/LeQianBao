package com.leqian.bao.view.imageview;
...
public class ClipImageView extends android.support.v7.widget.AppCompatImageView implements View.OnTouchListener, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private int BORDER_LINE_WIDTH;   //框框宽度
    ...
    public ClipImageView(Context context, AttributeSet attrs) {
        ...
        setBorderDistance((int) a.getDimension(R.styleable.ClipImageView_ClipIV_BorderDistance, 50));
        setBorderWidth((int) a.getDimension(R.styleable.ClipImageView_ClipIV_BorderWidth, 2));
        setBorderColor(a.getColor(R.styleable.ClipImageView_ClipIV_BorderColor, Color.WHITE));
        setOutsideColor(a.getColor(R.styleable.ClipImageView_ClipIV_OutsideColor, Color.parseColor("#76000000")));
        a.recycle();
