package com.leqian.bao.view.refresh;
 ...
 * desc:
 */
public class MybBezierCircleHeader extends InternalAbstract implements RefreshHeader {
    ...
    public MybBezierCircleHeader(Context context) {
        this(context, null);
    }

    public MybBezierCircleHeader(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MybBezierCircleHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        waveAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (!mWavePulling) {
                    ...
                    final View thisView = MybBezierCircleHeader.this;
                    thisView.invalidate();
                }
            }
        });
