...
class PermissionsManager {
    ...
    public synchronized void requestPermissionsIfNecessaryForResult(@Nullable Activity activity,
                                                                    ...
                                                                    @Nullable PermissionsResultAction action, int rquestCode, boolean isPermsToRequest) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            ...
            if (isPermsToRequest) {
                ...
                if (permList.isEmpty()) {
                    ...
                    ActivityCompat.requestPermissions(activity, permsToRequest, rquestCode);
                }
            } else {
                ActivityCompat.requestPermissions(activity, permissions, rquestCode);
            }
    ...
    public synchronized void requestPermissionsIfNecessaryForResult(@Nullable Activity activity,
                                                                    @NonNull String[] permissions,
                                                                    @Nullable PermissionsResultAction action) {
        requestPermissionsIfNecessaryForResult(activity, permissions, action, 1, true);
    }
    ...
    public synchronized void requestPermissionsIfNecessaryForResult(@NonNull Fragment fragment,
                                                                    @NonNull String[] permissions,
                                                                    @Nullable PermissionsResultAction action, boolean isPermsToRequest) {
    ...
    public synchronized void requestPermissionsIfNecessaryForResult(@NonNull Fragment fragment,
                                                                    @NonNull String[] permissions,
                                                                    @Nullable PermissionsResultAction action) {
        requestPermissionsIfNecessaryForResult(fragment, permissions, action, true);
    }
