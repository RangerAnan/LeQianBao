...
/**
 * 取消TabLayout中viewpager的左右滑动动画:mViewPager.setCurrentItem
 */
@ViewPager.DecorView
public class UnScrollAnimTabLayout extends HorizontalScrollView {
    ...
    /**
     * Gravity used to fill the {@link UnScrollAnimTabLayout} as much as possible. This option only takes effect
    ...
    /**
     * Gravity used to lay out the tabs in the center of the {@link UnScrollAnimTabLayout}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
    ...
    public UnScrollAnimTabLayout(Context context) {
        this(context, null);
    }
    public UnScrollAnimTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public UnScrollAnimTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    /**
     * Add a {@link UnScrollAnimTabLayout.OnTabSelectedListener} that will be invoked when tab selection
     * changes.
     * <p>
    ...
    /**
     * Remove the given {@link UnScrollAnimTabLayout.OnTabSelectedListener} that was previously added via
    ...
    /**
     * Remove all previously added {@link UnScrollAnimTabLayout.OnTabSelectedListener}s.
     */
    ...
    /**
     * Returns the current mode used by this {@link UnScrollAnimTabLayout}.
     *
     * @see #setTabMode(int)
     */
    @Mode
    ...
    /**
     * The one-stop shop for setting up this {@link UnScrollAnimTabLayout} with a {@link ViewPager}.
     * <p>
     ...
     * necessary calls back to the provided {@link UnScrollAnimTabLayout} so that the tab position is
     * kept in sync.
     * <p>
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<UnScrollAnimTabLayout> mTabLayoutRef;
        private int mPreviousScrollState;
        private int mScrollState;

        public TabLayoutOnPageChangeListener(UnScrollAnimTabLayout tabLayout) {
        ...
        public void onPageScrolled(final int position, final float positionOffset,
            ...
            final UnScrollAnimTabLayout tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
    ...
    /**
     * A {@link UnScrollAnimTabLayout.OnTabSelectedListener} class which contains the necessary calls back
     * to the provided {@link ViewPager} so that the tab position is kept in sync.
     */
    public static class ViewPagerOnTabSelectedListener implements UnScrollAnimTabLayout.OnTabSelectedListener {
