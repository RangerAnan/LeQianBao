package com.nxin.base.view.swipeback;
...
public class SwipeBackLayout extends FrameLayout {
    ...
    private IOnFinishListener iOnFinishListener;
    ...
    public void setOnFinishListener(IOnFinishListener iOnFinishListener) {
        this.iOnFinishListener = iOnFinishListener;
    }
            ...
            if (mScrollPercent >= 1) {
                if (!mActivity.isFinishing()) {
                    if (iOnFinishListener != null) {
                        iOnFinishListener.onSwipeFinish();
                    }
                    mActivity.finish();
